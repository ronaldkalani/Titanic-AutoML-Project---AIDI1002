...
def test_hpo_and_bagging_invalid_resources_per_fold_more_than_total(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        ...
        base_model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 10, "num_gpus": 1}})
        base_model.initialize()
        bagged_model = DummyBaggedModel(model_base=base_model, hyperparameters={"ag_args_fit": {"num_cpus": 2, "num_gpus": 2}})
...
def test_hpo_and_bagging_invalid_resources_per_fold_less_than_minimum(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        ...
        base_model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0}})
        base_model.initialize()
        bagged_model = DummyBaggedModel(model_base=base_model, hyperparameters={"ag_args_fit": {"num_cpus": 2, "num_gpus": 2}})
        bagged_model.initialize()
        with pytest.raises(AssertionError) as e:
...
def test_hpo_and_bagging_invalid_resources_per_trial_more_than_total(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        ...
        base_model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 1}})
        base_model.initialize()
        bagged_model = DummyBaggedModel(model_base=base_model, hyperparameters={"ag_args_fit": {"num_cpus": 10, "num_gpus": 1}})
        bagged_model.initialize()
        with pytest.raises(AssertionError) as e:
            executor.register_resources(bagged_model, k_fold=8, X=dummy_x, **total_resources)
...
def test_hpo_and_bagging_invalid_resources_per_trial_less_than_minimum(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        ...
        base_model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0.1}})
        base_model.initialize()
        bagged_model = DummyBaggedModel(model_base=base_model, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0}})
        bagged_model.initialize()
        with pytest.raises(AssertionError) as e:
            executor.register_resources(bagged_model, k_fold=8, X=dummy_x, **total_resources)
...
def test_hpo_and_bagging_valid_resources_per_fold_and_valid_resources_per_trial(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        ...
        base_model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0.1}})
        base_model.initialize()
        bagged_model = DummyBaggedModel(model_base=base_model, hyperparameters={"ag_args_fit": {"num_cpus": 4, "num_gpus": 0.5}})
        bagged_model.initialize()
        executor.register_resources(bagged_model, k_fold=8, X=dummy_x, **total_resources)
...
def test_hpo_without_bagging_invalid_resources_per_trial_more_than_total_resources(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        # Test valid resources per fold and resources per trial
        model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 10, "num_gpus": 0.2}})
        model.initialize()
        with pytest.raises(AssertionError) as e:
...
def test_hpo_without_bagging_invalid_resources_per_trial_less_than_minimum_resources(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        # Test valid resources per fold and resources per trial
        model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0.01}})
        model.initialize()
        with pytest.raises(AssertionError) as e:
            executor.register_resources(model, X=dummy_x, **total_resources)
...
def test_hpo_without_bagging_valid_resources_per_trial(mock_system_resources_ctx_mgr, executor_cls):
    ...
    with mock_system_resources_ctx_mgr(num_cpus=total_resources["num_cpus"], num_gpus=total_resources["num_gpus"]):
        # Test valid resources per fold and resources per trial
        model = DummyModel(minimum_resources={"num_cpus": 1, "num_gpus": 0.1}, hyperparameters={"ag_args_fit": {"num_cpus": 1, "num_gpus": 0.2}})
        model.initialize()
        executor.register_resources(model, X=dummy_x, **total_resources)
