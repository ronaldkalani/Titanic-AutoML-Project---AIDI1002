...
def test_v0_4_0_checkpoint_hf_text():
    ...
    save_path = os.path.join(get_home_dir(), "checkpoints_0.4.0_backward_compatible")
...
def test_v0_6_2_checkpoint_timm_image():
    ...
    verify_predictor_save_load(predictor, test_df, cls=MultiModalPredictor)
